...
const en: Dict = {
  ...
  "changelog.v11-2.version": "v0.11.2",
  "changelog.v11-2.date": "Sep 5, 2026",
  "changelog.v11-2.title": "Clearer layered quotas and current renewal dates",
  "changelog.v11-2.bullet1": "Low secondary quotas now keep their true height while showing a crisp dashed boundary in the menu bar, so values such as 7% remain visible without being rounded up",
  "changelog.v11-2.bullet2": "Codex no longer reuses an expired date from stale local sign-in metadata as the current subscription renewal date",
  "changelog.v11-2.bullet3": "If the current renewal date cannot be verified, Quota Bar now leaves it blank instead of guessing or displaying an old billing cycle",
  "changelog.v11-1.version": "v0.11.1",
  "changelog.v11-1.date": "Aug 8, 2026",
  "changelog.v11-1.title": "Expired-subscription detection",
  "changelog.v11-1.bullet1": "Claude, Kimi and opencode now show \u201cnot subscribed or subscription expired\u201d when the account has no active plan, instead of misleading full-quota bars with an unknown reset time",
  "changelog.v11-1.bullet2": "A server-side \u201cno active subscription\u201d signal from any data source now overrides weaker config-only signals across all providers",
  "changelog.v11-1.bullet3": "Claude usage windows without a reset time no longer count as a valid quota, so expired accounts stop showing stale full bars",
  "changelog.v11.version": "v0.11.0",
  "changelog.v11.date": "Jul 20, 2026",
  "changelog.v11.title": "7-day trial & license activation",
  "changelog.v11.bullet1": "Added a 7-day free trial. When it ends, quota tracking keeps working exactly as before — only automatic updates pause until you activate",
  "changelog.v11.bullet2": "You can now buy a license from the website and activate it in Preferences → Activation",
  "changelog.v11.bullet3": "Installers are now served from this site instead of GitHub releases, so downloads work in more places",
  "changelog.v10-1.version": "v0.10.1",
  "changelog.v10-1.date": "Jul 20, 2026",
  "changelog.v10-1.title": "Per-channel status & update fixes",
  "changelog.v10-1.bullet1": "Preferences → Models now shows the status of each data source per provider — which succeeded automatically, which failed, and a one-click authorize action for sources that need it",
  "changelog.v10-1.bullet2": "Fixed Kimi's hourly and weekly quota not showing, and its monthly bar not matching the style of other providers",
  "changelog.v10-1.bullet3": "Fixed the app sometimes reporting \"up to date\" when a newer version was actually available",
...
const zh: Dict = {
  ...
  "changelog.back": "← 返回首页",
  "changelog.v11-2.version": "v0.11.2",
  "changelog.v11-2.date": "2026-09-05",
  "changelog.v11-2.title": "次级额度更清晰，续费日期更可靠",
  "changelog.v11-2.bullet1": "菜单栏里的低比例次级额度现在会保持真实高度并显示清晰虚线边界，7% 等数值无需虚增也能辨认",
  "changelog.v11-2.bullet2": "Codex 不再把本地登录信息中过期的历史日期当作当前订阅续费日重复展示",
  "changelog.v11-2.bullet3": "当前续费日无法确认时会留空，不再猜测月份或显示旧账期日期",
  "changelog.v11-1.version": "v0.11.1",
  "changelog.v11-1.date": "2026-08-08",
  "changelog.v11-1.title": "订阅过期识别",
  "changelog.v11-1.bullet1": "Claude、Kimi、opencode 的账号无有效订阅时显示「未订阅或订阅已过期」，不再把无重置时间的窗口显示成误导性的满额度条",
  "changelog.v11-1.bullet2": "任一数据源返回服务端权威的「无有效订阅」信号时，会覆盖其他来源的弱信号（如本地 CLI 的档位）",
  "changelog.v11-1.bullet3": "Claude 无重置时间的额度窗口不再被视为有效额度，订阅已过期的账号不再显示陈旧的满格额度条",
  "changelog.v11.version": "v0.11.0",
  "changelog.v11.date": "2026-07-20",
  "changelog.v11.title": "7 天试用与授权激活",
  "changelog.v11.bullet1": "新增 7 天免费试用。试用结束后额度获取照常工作，只有自动更新会暂停，激活后即可恢复",
  "changelog.v11.bullet2": "现在可以在官网购买许可证，并在「偏好设置 → 激活」里激活",
  "changelog.v11.bullet3": "安装包改为从官网分发（不再走 GitHub Release 附件），下载在更多网络环境下可用",
  "changelog.v10-1.version": "v0.10.1",
  "changelog.v10-1.date": "2026-07-20",
  "changelog.v10-1.title": "分渠道状态与更新修复",
  "changelog.v10-1.bullet1": "「偏好设置 → 模型」现在会显示每个 provider 各数据渠道的获取状态——哪些自动成功、哪些失败，需要授权的渠道可以直接点击去授权",
  "changelog.v10-1.bullet2": "修复 Kimi 小时和周额度不显示、月额度进度条样式跟其他 provider 不一致的问题",
  "changelog.v10-1.bullet3": "修复某些情况下明明有新版本，检查更新却显示已是最新版本的问题",
  "changelog.v10.version": "v0.10.0",
